...
public class TestFileCatalogLoader {
	...
	public void testLoadCatalog() throws IOException {
		...
		try {
			...
			Catalog emptyCatalog = loader.loadCatalog(
					"C:\\Users\\DELL\\Desktop\\GourmetCoffeeFile\\Gourmet Coffee- File\\student-files\\empty.dat");
			...
			Catalog catalog = loader.loadCatalog(
					"C:\\Users\\DELL\\Desktop\\GourmetCoffeeFile\\Gourmet Coffee- File\\student-files\\catalog.dat");
